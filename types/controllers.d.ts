interface DomQueries {
    findElement(selector: string, scope?: ParentNode): HTMLElement;
    findElements(selector: string, scope?: ParentNode): HTMLElement[];
}
...
interface MotionRanges {
    pageMotion: SettingRange;
    cardTilt: SettingRange;
    backgroundDust: SettingRange;
    backgroundDustSpeed: SettingRange;
}
